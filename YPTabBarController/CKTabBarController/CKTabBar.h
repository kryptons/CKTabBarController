...
#import "CKTabItem.h"
@class CKTabBar;
@protocol CKTabBarDelegate <NSObject>

@optional
- (BOOL)CK_tabBar:(CKTabBar *)tabBar willSelectItemAtIndex:(NSInteger)index;
- (void)CK_tabBar:(CKTabBar *)tabBar didSelectedItemAtIndex:(NSInteger)index;

@end

@interface CKTabBar : UIView <UIScrollViewDelegate>

@property (nonatomic, copy) NSArray<CKTabItem *> *items; // TabItems
...
@property (nonatomic, weak) id<CKTabBarDelegate> delegate;
