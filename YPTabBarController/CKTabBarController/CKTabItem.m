...
- (void)awakeFromNib {
    ...
    _badgeStyle = CKTabItemBadgeStyleNumber;
    self.badge = 0;
...
//    self.numberBadgeFrame = CKTabItemBadgeFrameMake(2, 20, 16);
//    self.dotBadgeFrame = CKTabItemBadgeFrameMake(5, 25, 10);
}
...
- (void)setBadgeStyle:(CKTabItemBadgeStyle)badgeStyle {
    _badgeStyle = badgeStyle;
    [self updateBadge];
}

- (void)updateBadge {
    if (self.badgeStyle == CKTabItemBadgeStyleNumber) {
        if (self.badge == 0) {
    ...
    } else if (self.badgeStyle == CKTabItemBadgeStyleDot) {
