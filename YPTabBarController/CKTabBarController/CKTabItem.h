 ...
 *  Badge样式
 */
typedef NS_ENUM(NSInteger, CKTabItemBadgeStyle) {
    CKTabItemBadgeStyleNumber = 0, // 数字样式
    CKTabItemBadgeStyleDot = 1, // 小圆点
};

@interface CKTabItem : UIButton
 ...
 *  badge == 0，隐藏badge
 *  badge < 0，显示一个小圆点，即CKTabItemBadgeStyleDot
 */
@property (nonatomic, assign) NSInteger badge;

@property (nonatomic, assign) CKTabItemBadgeStyle badgeStyle;
